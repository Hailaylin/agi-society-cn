...
When multiple theories on intelligence are proposed, they should be compared and evaluated according to the following criteria, which come from the above discussion and [[6.2|Section 6.2]]:
...
Like in other branches of science, we cannot expect a perfect theory of intelligence, though we can expect one that is better than the existing theories, as explained in [[6.3|Section 6.3]].
