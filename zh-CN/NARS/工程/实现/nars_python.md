...
![1](../../../image/nars/impl/nars_python/tutorial_1.png)
...
![2](../../../image/nars/impl/nars_python/tutorial_2.png)

解压到D盘，结构如下：

![3](../../../image/nars/impl/nars_python/tutorial_3.png)

双击桌面的 PyCharm 图标，然后打开解压后的目录：

![4](../../../image/nars/impl/nars_python/tutorial_4.png)

（下面这个步骤**不是必要的**）除非编辑器找不到 python.exe 或你想换一个 python.exe 版本：

![5](../../../image/nars/impl/nars_python/tutorial_5.png)

接下来试着右键点击并启动 main.py （应该会报错，因为缺少某些库）：

![6](../../../image/nars/impl/nars_python/tutorial_6.png)
